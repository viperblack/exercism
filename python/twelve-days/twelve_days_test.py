...
class TwelveDaysTest(unittest.TestCase):
    ...
    def test_first_day_a_partridge_in_a_pear_tree(self):
        ...
        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam sed.
        """
        expected = ['On the first day of Christmas my true ',
    ...
    def test_second_day_two_turtle_doves(self):
        ...
        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam sed.
        """
        expected = ['On the second day of Christmas my true love gave ',
    ...
    def test_third_day_three_french_hens(self):
        ...
        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam sed.
        """
        expected = ['On the third day of Christmas my true love',
        'gave to me: three French Hens, two Turtle Doves, and a Partridge in a Pear Tree.']
